# Java 编码规范
<div align="right">
  <a href="编码规范.en.md"><kbd>English</kbd></a>
</div>

> 欢迎一起开发！请务必遵守本规范以保持一致性与可维护性。

## 适用范围
- 适用于本项目所有 Java 代码（含测试代码）
- 若与现有代码风格冲突，以本规范为准并逐步统一

## 文件头要求
每个 `.java` 文件必须包含以下文件头注释，并放在 **package/import 之后**：
```java
/**
